...
namespace LoRaWan.SimulatedTest
{
    ...
    public sealed class SimulatorTestCollection : IntegrationTestBaseSim
    {
        ...
        {
            // amount of devices to test with.
            // Maximum depends on Edge Hub env var. "MaxConnectedClients"
            ...
            int warmUpDeviceStepSize = 2; // Default: 2
            ...
            int delayWarmup = 20 * 1000;

            // amount of seconds to wait between sends in main phase
            int delayMessageSending = 20 * 1000;
